...
_interfacemenu=_materialmenu.addItem(OOFMenuItem(
    'Interface',
    discussion="""
...
_interfacemenu.addItem(OOFMenuItem(
    ...
    params=[
        whoville.WhoParameter(
            ...
            ooflib.common.microstructure.microStructures,
            tip=parameter.emptyTipString),
        materialparameter.InterfaceMaterialParameter(
            'material',
            tip="Interface material to be assigned."),
        interfaceparameters.SkelAllParameter(
            "skeleton",
            tip="Skeleton name"),
        interfaceparameters.ListOfInterfacesCombinedBdysParameter(
            "interfaces",
            tip="Current list of named interfaces and boundaries"
            " defined in this microstructure.")
...
##                                                                 tip="Current list of named interfaces and boundaries defined in this microstructure.")
    ...
    This command assigns a &material; to a list of interfaces and
    skeleton boundaries in the microstructure. When the &mesh; is
    created, an element is created for every edge belonging to an
    interface or skeleton boundary, and each element is assigned the
    material that was assigned to the interface or skeleton boundary.
